...
require 'fileutils'
sitepp_file="./site.pp"
backup_sitepp_file="./site.pp.packer.backup"


#sitepp_file="/etc/puppetlabs/code/environments/site/manifests/site.pp"
#backup_sitepp_file="/etc/puppetlabs/code/environments/site/manifests/site.pp.packer.backup"
...
if File.file?(backup_sitepp_file)
    ...
    f.each {|line|
      if   line =~ /^\$hostgroup.*=.*default.$/
        ...
        h.puts " /^ws\\d+.*/:            { \$hostgroup = 'workstation'        }"
